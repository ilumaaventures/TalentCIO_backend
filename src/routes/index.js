...
const talentAcquisitionRoutes = require('../modules/talent-acquisition/talentAcquisition.routes');
const emailTemplateRoutes = require('../modules/email/emailTemplate.routes');
const candidateRoutes = require('../modules/talent-acquisition/candidate.routes');
const workflowRoutes = require('../modules/workflow/workflow.routes');
const interviewWorkflowRoutes = require('../modules/talent-acquisition/interviewWorkflow.routes');
...
const hrEmailRoutes = require('../modules/email/hrEmail.routes');
...
const phaseTemplateRoutes = require('../modules/talent-acquisition/phaseTemplate.routes');
const candidateDynamicPhaseRoutes = require('../modules/talent-acquisition/candidateDynamicPhase.routes');
const binRoutes = require('../modules/bin/bin.routes');
const emailSettingsRoutes = require('../modules/email/emailSettings.routes');
const notificationSettingsRoutes = require('../modules/notification/notificationSettings.routes');
const emailBrandingRoutes = require('../modules/email/emailBranding.routes');
const emailBrandingTemplateRoutes = require('../modules/email/emailBrandingTemplate.routes');
