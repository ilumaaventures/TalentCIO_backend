...
const { attachDiscussionPermissions, buildAccessibleDiscussionMatch } = require('../discussion/discussion.access');
...
const { populateWorkLogHierarchy, mapWorkLogToTimesheetEntry } = require('../timesheet/timesheet.controller');
    ...
    try {
        ...
        const groupedPermissions = filteredPermissions
            .reduce((acc, curr) => {
                ...
                else if (curr.key.startsWith('crm.')) groupName = 'SALES CRM';
