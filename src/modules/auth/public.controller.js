...
const Applicant = require('../auth/applicant.model');
const User = require('../user/user.model');
const Company = require('../company/company.model');
const HandoffToken = require('../auth/handoffToken.model');
const { HiringRequest } = require('../talent-acquisition/model/hiringRequest.model');
const PublicApplication = require('../talent-acquisition/model/publicApplication.model');
const { check3MonthApplicationLock } = require('../talent-acquisition/utils/applicationHistoryUtils');
...
const { setSessionCookie } = require('../../common/utils/sessionCookies');
