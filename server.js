...
require('./src/modules/attendance/model/attendance.model');
require('./src/modules/attendance/model/attendanceDocument.model');
require('./src/modules/project/project.model');
require('./src/modules/timesheet/timesheet.model');
require('./src/modules/leave/model/leaveConfig.model');
require('./src/modules/leave/model/leaveBalance.model');
require('./src/modules/leave/model/leaveRequest.model');
require('./src/modules/talent-acquisition/model/candidate.model');
require('./src/modules/email/model/emailTemplate.model');
require('./src/modules/auth/applicant.model');
require('./src/modules/talent-acquisition/model/publicApplication.model');
require('./src/modules/auth/handoffToken.model');
require('./src/modules/talent-acquisition/model/interviewWorkflow.model');
...
require('./src/modules/crm/models/crmLead.model');
require('./src/modules/crm/models/crmDeal.model');
require('./src/modules/crm/models/crmAccount.model');
require('./src/modules/crm/models/crmContact.model');
require('./src/modules/crm/models/crmPipeline.model');
require('./src/modules/crm/models/crmActivity.model');
require('./src/modules/crm/models/crmTask.model');
require('./src/modules/crm/models/crmFollowUp.model');
require('./src/modules/crm/models/crmTarget.model');
require('./src/modules/crm/models/crmCommission.model');
require('./src/modules/crm/models/crmSequence.model');
require('./src/modules/crm/models/crmCampaign.model');
require('./src/modules/crm/models/crmWorkflow.model');
require('./src/modules/crm/models/crmCustomField.model');
require('./src/modules/crm/models/crmTerritory.model');
